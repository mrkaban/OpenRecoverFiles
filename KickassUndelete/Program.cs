		...
		static void EnsureUserIsAdmin() {
			if (IsWindows()) {
				...
				if (!principal.IsInRole(WindowsBuiltInRole.Administrator)
					&& MessageBox.Show(
                    "Предупреждение: в настоящее время вы не используете учетную запись администратора. " +
                    "Это означает, что вы сможете восстанавливать файлы только из внешних " +
                    "дисков, таких как флэш-накопители и SD-карты. Вы бы хотели работать " +
                    "как администратор? Вам понадобится пароль для вашей " +
                    "учетной записи администратора.", "Предупреждение", MessageBoxButtons.YesNo,
